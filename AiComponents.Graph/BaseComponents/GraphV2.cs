...
{
    public partial class GraphV2<VertexLabelType, EdgeLabelType>
        where VertexLabelType : NodeBaseContextEntity
    {
        /**
	 ...
	 */
        ...
        private readonly Dictionary<Type,Dictionary<VertexLabelType,EdgeLabelType>> edgeLabels;
